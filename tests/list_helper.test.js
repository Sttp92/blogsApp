...
describe('favorite blogs', () => {
  ...
  test('when list has only one blog, thats the favorite one', () => {
...
describe('most blogs', () => {
  ...
  test('when list has only one blog, thats the author with most blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list has only one blog, thats the author with most likes', () => {
